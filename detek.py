import cv2
sampah =cv2.CascadeClassifier("sampah1.xml")###path of cascade file
...
img= cv2.imread("D:\\PKM\\dataset\\anorganik\\botol(1).jpg")###path of image file which we want to detect
resized = cv2.resize(img,(400,200))
gray=cv2.cvtColor(resized,cv2.COLOR_BGR2GRAY)
faces = sampah.detectMultiScale(gray,6.5,17)#try to tune this 6.5 and 17 parameter to get good result 
